...
export const desktopBoardAssetSources = {
  ...
  surveyMap: {
    ...
    source: "new board pack assets/board pack/map 1.png",
  },
  routeIndexMap: {
    runtime: assetPath("/hero-curated/locked/desktop-board/maps/map-3.png"),
    source: "new board pack assets/board pack/map 3.png",
  },
  activationMap: {
    runtime: assetPath("/hero-curated/locked/desktop-board/maps/map-2.png"),
    source: "new board pack assets/board pack/map 2.png",
  },
  zone01Card: {
...
export const desktopBoardElements = {
  ...
  activationMapRef: createTextItem(
    ...
    {
      desktop: { x: 1450, y: 136, maxWidth: 130, zIndex: 9 },
    },
  ),
  activationMapTitle: createTextItem(
    ...
    "board-item--red-display board-item--map-title",
    {
      desktop: { x: 1218, y: 164, maxWidth: 336, zIndex: 9 },
    },
  ),
  activationMapSubline: createTextItem(
    ...
    "board-item--editorial-subline",
    {
      desktop: { x: 1164, y: 204, maxWidth: 392, zIndex: 9 },
    },
  ),
  activationPriorityStamp: createTextItem(
    ...
    {
      desktop: { x: 1184, y: 398, maxWidth: 220, zIndex: 10 },
    },
  ),
  ...
  zone03Ref: createTextItem("REF. 005", "board-item--red-display board-item--zone-ref", {
    desktop: { x: 1398, y: 14, maxWidth: 122, zIndex: 11 },
  }),
  zone04Ref: createTextItem("REF. 007", "board-item--red-display board-item--zone-ref", {
    desktop: { x: 1432, y: 454, maxWidth: 122, zIndex: 11 },
  }),
  ...
  zone03Headline: createTextItem(
    ...
    "board-item--red-display board-item--zone-headline",
    {
      desktop: { x: 1122, y: 104, maxWidth: 214, zIndex: 11 },
    },
  ),
  zone04Headline: createTextItem(
    ...
    "board-item--red-display board-item--zone-headline",
    {
      desktop: { x: 1200, y: 518, maxWidth: 206, zIndex: 11 },
    },
  ),
  primarySiteBox: createTextItem(
    ...
    {
      desktop: { x: 948, y: 496, maxWidth: 174, zIndex: 14 },
      parallaxDepth: 0.2,
    },
  ),
